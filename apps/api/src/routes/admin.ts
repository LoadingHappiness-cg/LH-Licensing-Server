...
const planSchema = z.object({
  ...
  renewalCadenceMonths: z.coerce.number().int().positive().optional().or(z.literal("")),
...
export async function registerAdminRoutes(app: FastifyInstance) {
  ...
  app.post("/license-plans", async (request, reply) => {
    ...
    const plan = await createPlan({
      ...
      renewalCadenceMonths: typeof body.data.renewalCadenceMonths === "number" ? body.data.renewalCadenceMonths : undefined,
  ...
  app.patch("/license-plans/:id", async (request, reply) => {
    ...
    const plan = await updatePlan((request.params as { id: string }).id, {
      ...
      renewalCadenceMonths: body.data.renewalCadenceMonths === "" ? undefined : body.data.renewalCadenceMonths,
